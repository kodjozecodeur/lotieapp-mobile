...
import '../../auth/screens/simple_login_screen.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> with TickerProviderStateMixin {
  ...
  Future<void> _completeOnboarding() async {
    try {
      ...
      logger.info('[OnboardingScreen] Onboarding completed and saved');
      ...
      logger.error('[OnboardingScreen] Error completing onboarding: $e');
  ...
  /// Handle login action - use simple login flow
  void _handleLogin() {
    Navigator.push(
      context,
      MaterialPageRoute(
