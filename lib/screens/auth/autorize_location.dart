...
import 'autorize_notification.dart';

/// Location authorization screen (Step 2)
///
/// This screen requests location permission from the user.
/// It features:
...
class AutorizeLocationScreen extends StatefulWidget {
  const AutorizeLocationScreen({super.key});

  @override
  State<AutorizeLocationScreen> createState() => _AutorizeLocationScreenState();
}

class _AutorizeLocationScreenState extends State<AutorizeLocationScreen>
  ...
  Future<void> _handleLocationAuthorization() async {
    ...
    try {
      logger.info('[AutorizeLocationScreen] Requesting location permission');
      ...
      if (mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AutorizeNotification(),
          ),
        );
      }
    } catch (e) {
      ...
      children: List.generate(3, (index) {
        return Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: index <= 1 ? DesignTokens.primary950 : DesignTokens.neutral550.withValues(alpha: 0.3), // Steps 1 and 2 active
    ...
    return  Center(
      child: Container(
        ...
        child: SvgPicture.asset(
          'assets/icons/location.svg', // You can replace with your success icon
          width:240.w,
          height: 240.h,
  ...
  Widget _buildTitleGroup() {
    return Column(
      ...
      children: [
        ...
        // Subtitle
        Text(
          'Nous utilisons votre position pour vous proposer les meilleurs services à proximité',
          textAlign: TextAlign.center,
          style: TextStyle(
  ...
  Widget _buildContinueButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: _isLoading ? null : _handleLocationAuthorization,
